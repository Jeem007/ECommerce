...
@section('page-title')
<title>Update Category Information || ECommerce Platform</title>
@endsection
                ...
                <div class="row">
                    <div class="col-lg-4"> 
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" placeholder="Category Name" value="{{$category->name}}" class="form-control" required autocomplete="off" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select mb-3" aria-label="Default select example" name="is_parent">
                                ...
                                @if($pCat->id == $category->is_parent ) selected  @endif
                                >{{$pCat->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <textarea name="description" class="form-control" rows="5" placeholder="Write Descrition....">{{$category->description}}</textarea>
                    </div>
                    <div class="mb-3">
