...
<!-- page title -->
@section('page-title')
<title>Manage All Divisions || ECommerce Platform</title>
@endsection
<!-- body css -->
@section('body-css')
    ...
    <div class="card radius-10 w-100">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <div>
                    <h5 class="mb-0">Manage All Divisions</h5>
                </div>
                <div class="dropdown options ms-auto"> 
                     <a href="{{route('division.trash')}}" class="btn btn-primary btn btn-sm">View Trash</a>
                </div>
            </div> 
        </div>
        <div class="card-body">
