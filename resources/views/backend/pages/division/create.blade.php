                ...
                <div class="row">
                    <div class="col-lg-4"> 
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" placeholder="Division Name" class="form-control" required autocomplete="off" />
                        </div>

                        <div class="mb-3">
                            <label>Priority Number</label>
                            <input type="number" name="priority_num" placeholder="Division Priority Number" class="form-control" />
                        </div>
